...
try:
    if "OPENAI_API_KEY" in st.secrets:
        OPENAI_API_KEY = st.secrets["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"]
except Exception:
    pass
